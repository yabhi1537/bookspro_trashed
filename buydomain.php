<?php include('includes/header.php');
 ...
 //print_r($sql);die();
   if ($mysql==true) {
    ...
    echo "<script>location.href='buydomain.php'</script>";
    }else{
  ...
  <div class="container py-5">
    <div class="row align-items-center py-4">
      <div class="col-md-6 text-center text-md-left">
        <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase"><strong style="color:white">Buy Domain
          </strong></h1>
      </div>
      <div class="col-md-6 text-center text-md-right">
        <div class="d-inline-flex align-items-center">
          ...
          <a class="btn btn-sm btn-outline-light disabled" href="">Buy Domain</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-lg-5">
        ...
        <!-- <img class="img-fluid" src="img/hosting2.gif" alt=""> -->
      </div>
...
<div class="container">
  <div class="row justify-content-around mt-5 mb-5 text-center">
    ...
    <!--    <h2>Hostinger</h2>-->
    <!--    <h3>33% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open(' https://hostinger.in?REFERRALCODE=1HEMANTJARO77_blank'); return false;">Buy-->
    <!--      Now</button>-->
    <!--  </div>-->
    <!--</div>-->
    ...
    <!--    <h3>29% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open('https://www.bluehost.in/', '_blank'); return false;">Buy Now</button>-->
    <!--  </div>-->
    <!--</div>-->
    ...
    <!--    <h3>30% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open('https://www.godaddy.com/en-in', '_blank'); return false;">Buy Now</button>-->
    <!--  </div>-->
    <!--</div>-->
  </div>
  <!-- Services End -->
  ...
  <!--<div class="row justify-content-around mt-5 mb-5 text-center">-->
    ...
    <!--    <h3>20% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open('https://www.inmotionhosting.com/'); return false;">Buy Now</button>-->
    <!--  </div>-->
    <!--</div>-->
    ...
    <!--    <h3>24% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open('https://www.a2hosting.in/', '_blank'); return false;">Buy Now</button>-->
    <!--  </div>-->
    <!--</div>-->
    ...
    <!--    <h3>28% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open('https://www.hostpapa.in/', '_blank'); return false;">Buy Now</button>-->
    <!--  </div>-->
    <!--</div>-->
    ...
    <!--    <h3>18% OFF</h3>-->
    <!--    <button title="button" class="action primary tocart domain-btn"-->
    <!--      onclick=" window.open('https://www.bigrock.in/', '_blank'); return false;">Buy Now</button>-->
    <!--  </div>-->
    <!--</div>-->
    <!-- Services End -->
  <!--</div>-->
