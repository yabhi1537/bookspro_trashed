        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase"><strong style="color:white">SEO
                    </strong></h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn btn-sm btn-outline-light disabled" href="">SEO</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid pt-5 pb-3">
    <div class="container">
        <?php 
            ...
            ?>
        <h1 class="display-4 text-center mb-5"><strong style="font-size: 43px;"><?php echo $row['tittle'];?> </strong></h1><?php }?>
         ...
         <?php 
            ...
            <div class="col-lg-4 mb-2">
                <div class="shadow mb-4" style="height:400px;">
                    ...
                    <p class="m-0 p-4"><?php echo $row['massage'];?>Software development with effective digital transformation to help you tackle all technical challenges. 
                        <br> 
                        <br>
                    </p>
                </div>
